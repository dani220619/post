<div class="main-panel">
    <div class="content">
        <div class="page-inner">
            <form class="admin" method="post" action="<?= base_url('admin/edit_post'); ?>" enctype="multipart/form-data">
                <div class="row">
                    <input hidden type="text" class="form-control" id="id_user" name="id_user" value="<?= $user['id_user'] ?>" placeholder="Enter Title">
                    <input hidden type="text" class="form-control" id="id_post" name="id_post" value="<?= $post['id_post'] ?>" placeholder="Enter Title">
                    <div class="col-md-7">
                        <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="ckeditor" id="ckedtor" name="content" rows="5"><?= $post['content'] ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
